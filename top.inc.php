         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="adminindex.php"><img src="images/MyLogo.png" alt="Logo"></a>
                  <a class="navbar-brand hidden" href="adminindex.php"><img src="images/MyLogo.png" alt="Logo"></a>
